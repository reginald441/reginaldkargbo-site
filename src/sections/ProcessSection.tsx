...
const ProcessSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Glow Effects */}
      <div className="absolute top-1/3 right-1/4 w-72 h-72 bg-reg-primary/5 rounded-full blur-3xl" />
      <div className="absolute bottom-1/3 left-1/4 w-64 h-64 bg-reg-accent/5 rounded-full blur-3xl" />
