  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/images/reg-hero.png)',
      ...
      >
        ...
        <p
          ref={subheadlineRef}
          className="text-lg md:text-xl lg:text-2xl text-reg-text-secondary max-w-xl mb-8"
        >
          AI & Software Solutions Consultant helping small businesses build 
          powerful digital systems that increase efficiency and revenue.
        </p>
