  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/images/reg-philosophy.png)',
      ...
      >
        <div className="max-w-[46vw]">
          ...
          >
            Function over fluff. Results over rhetoric.
          </h2>

          {/* Body */}
          <p ref={bodyRef} className="body-text mb-8 md:mb-10 max-w-lg">
            My focus is not just on design, but on creating functional, 
            results-driven platforms that help clients grow and operate smarter. 
